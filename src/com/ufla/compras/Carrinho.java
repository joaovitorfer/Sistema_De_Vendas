...
/**
 * Representa um carrinho de compras do sistema.
 * O carrinho armazena itens selecionados pelo cliente,
 * permitindo adicionar, remover produtos, calcular o valor
 * total da compra e finalizar um pedido.
 *
 * @author Grupo 2 - UFLA
 * @version 1.0
 */
public class Carrinho {
    ...
    /**
     * Constrói um novo carrinho de compras.
     *
     ...
     * Caso o produto já exista na lista de itens,
     * sua quantidade é incrementada.
     * A quantidade adicionada não pode ultrapassar
    ...
    /**
     * Remove um produto do carrinho a partir do seu identificador.
     *
     ...
     * Após a finalização, o estoque dos produtos
     * é atualizado e o status do carrinho passa
     * para "Finalizado".
     *
     * @param idPedido identificador do pedido a ser criado
     * @return pedido gerado ou {@code null} caso o carrinho esteja vazio
     */
